...
export default function FetchCSVData(props) {
    ...
    const fetchCSVData = () => {
    const csvUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQ5LYUdFG8v4TdlmYP1th8uma3iROBFzdl9wE8aYvxkhHPLRmmVFNGHFf6bf539PoEO1MCEy9rQFPOg/pub?gid=0&single=true&output=csv'; // Replace with your Google Sheets CSV file URL
